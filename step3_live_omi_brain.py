...
print("=" * 100)
print("OMI BRAIN — STEP 3 — LIVE FRONTEND TELEMETRY")
print("=" * 100)
...
visualizer_original = VISUALIZER.read_text(
    encoding="utf-8-sig"
)

if "getAuthorizationHeaders" not in api_original:
    print("ABORT: Existing Scientist authentication client not found.")
    sys.exit(1)
...
api_backup = API.with_name(
    f"scientist-api.before_omi_brain_live_{stamp}.ts"
)

visualizer_backup = VISUALIZER.with_name(
    f"omi-brain-visualizer.before_live_{stamp}.tsx"
)
...
print("API backup        :", api_backup)
print("Visualizer backup :", visualizer_backup)

# ============================================================
# ADD API TYPES + FETCH FUNCTION
# ============================================================

api = api_original

if "export interface ScientistOmiBrain" not in api:
...
export interface ScientistOmiBrain {
...
'''
    ...
    marker = "export interface ScientistOverview {"

    if marker not in api:
        raise RuntimeError(
            "ScientistOverview marker not found."
        )
...
if "fetchScientistOmiBrain" not in api:

    api += r'''


export async function fetchScientistOmiBrain():
  Promise<ScientistOmiBrain> {

  const response =
    await axios.get(
      `${API_BASE_URL}/scientist/omi-brain`,
      {
        headers:
...
print("[OK] Scientist OMI Brain API client added")

# ============================================================
# REPLACE VISUALIZER WITH LIVE VERSION
# ============================================================
...
print("[OK] Live OMI Brain visualizer created")
print("[OK] Existing Scientist Bearer authentication reused")
print("[OK] TanStack Query polling = 1 second")
print("[OK] Browser-side animation only")
print("[OK] Fake learning values = NONE")
...
if result.returncode != 0:
    ...
    print()
    print("BUILD FAILED — RESTORING FRONTEND")
...
print()
print("=" * 100)
print("OMI BRAIN — STEP 3 SOURCE + BUILD COMPLETE")
print("=" * 100)
print("Frontend API wiring    : PASS")
print("Scientist auth         : PRESERVED")
print("1-second telemetry     : ENABLED")
print("Neural visualization   : LIVE-READY")
print("Stale detection        : ENABLED")
print("Fake learning          : NONE")
